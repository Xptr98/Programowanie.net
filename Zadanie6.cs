...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Generowanie pliku o wielkości 300MB
        GenerateLargeFile(sourceFilePath, 300);

        // Testowanie czasu kopiowania z użyciem FileStream
        TestFileStreamCopy(sourceFilePath, destinationFilePath);

        // Usunięcie plików źródłowych
    ...
    static void GenerateLargeFile(string filePath, int sizeInMB)
    {
        ...
        using (FileStream fileStream = new FileStream(filePath, FileMode.Create, FileAccess.Write))
        {
            ...
            long fileSize = sizeInMB * 1024L * 1024L; // Rozmiar w bajtach
